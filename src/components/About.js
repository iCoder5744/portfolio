...
export default function About() {
    return (
      <section id="about" className="py-16 px-6 md:px-12">
        ...
        <div className="max-w-4xl h-fit p-6 mx-auto border border-gray-300 dark:border-red-700 dark:bg-white rounded-xl">
          <p className="text-lg mb-8 text-center text-gray-600 dark:text-gray-100 font-serif">
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-300 dark:border-gray-700">
