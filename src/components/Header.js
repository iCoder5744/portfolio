...
export default function Header() {
  ...
  return (
    <section>
      {/* Top Section */}
      <div className='flex justify-between items-center shadow-xl bg-transparent transition-all duration-300 p-4 sm:px-8 sm:py-7 '>
        ...
        <div>
          {pathname === '/' ? (
            <button
              ...
              className='bg-gradient-to-r from-blue-700 to-purple-600 text-white max-sm:text-sm font-medium  px-4 py-1 rounded-full cursor-pointer'
            >
              Contact
            </button>
          ) : (
